...
.cmp-hero-photo{position:absolute;inset:0;z-index:0;background:url("/assets/profile/remy-hero.jpg") center 38%/cover no-repeat;filter:grayscale(1) contrast(1.1) brightness(1.1)}
.cmp-hero-photo::after{content:"";position:absolute;inset:0;mix-blend-mode:color;background:linear-gradient(115deg,#173b61 0%,#2f79b7 55%,#c8920a 100%)}
.cmp-hero-photo::before{content:"";position:absolute;inset:0;background:linear-gradient(100deg,rgba(23,59,97,.82) 0%,rgba(23,59,97,.68) 30%,rgba(23,59,97,.42) 55%,rgba(23,59,97,.15) 80%,rgba(23,59,97,.05) 100%)}
...
<header class="cmp-head">
  <div class="cmp-hero-photo" aria-hidden="true"></div>
