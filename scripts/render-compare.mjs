...
.cmp-hero-photo{position:absolute;inset:0;z-index:0;background:url("/assets/profile/remy-hero.jpg") center 18%/cover no-repeat;filter:grayscale(1) contrast(1.1) brightness(1.03)}
...
.cmp-hero-photo::before{content:"";position:absolute;inset:0;background:linear-gradient(100deg,#173b61 0%,rgba(23,59,97,.94) 30%,rgba(23,59,97,.62) 55%,rgba(23,59,97,.22) 80%,rgba(23,59,97,.08) 100%)}
