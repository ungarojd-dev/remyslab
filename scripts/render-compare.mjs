...
.cmp-head{position:relative;background:
    radial-gradient(circle at 12% 15%, rgba(246,217,149,.28) 0%, transparent 40%),
    radial-gradient(circle at 88% 10%, rgba(47,121,183,.65) 0%, transparent 45%),
    radial-gradient(circle at 70% 90%, rgba(200,146,10,.22) 0%, transparent 50%),
    linear-gradient(150deg,#0f2c48 0%,#173b61 35%,#1d4671 60%,#2f79b7 85%,#3d8ac4 100%);
...
<header class="cmp-head">
  <div class="cmp-hero-inner">
    <div>
      <img class="cmp-hero-avatar" src="/assets/profile/remy-hero.jpg" alt="Remy, a yellow Labrador" width="64" height="64" loading="eager"/>
      <span class="cmp-kicker">Remy's Lab · Pet product research</span>
      <h1>Good dog gear shouldn't cost a guessing game. <em>Or a fortune.</em></h1>
      <p>We started Remy's Lab after realizing how much we were overspending without knowing it. Now we compare real prices from brands with good products and better morals, so finding the right thing for your dog doesn't mean overpaying for it.</p>
